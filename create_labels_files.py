    ...
    for parent, dirnames, filenames in os.walk(dir):
        for filename in filenames:
            ...
            if curr_file == 'animal':
                ...
                labels = 1
            elif curr_file == 'building':
                labels = 2
            elif curr_file == 'car':
                labels = 3
            #elif curr_file == 'flower':
                #labels = 4
            elif curr_file == 'food':
                labels = 4
            elif curr_file == 'makeup':
                labels = 5
            elif curr_file == 'mountain':
                labels = 6
            #elif curr_file == 'nightscape':
                #labels = 7
            elif curr_file == 'night':
                labels = 7
            elif curr_file == 'painting':
                labels = 8
            elif curr_file == 'plant':
                labels = 9
            #elif curr_file == 'snow':
                #labels = 12
            elif curr_file == 'sea':
                labels = 10
            elif curr_file == 'travel':
                labels = 11
